...
This report was created using @Rcore. We also used packages created by @ggresidpanel, @broom, @tidyverse, @lubridate, @janitor, @knitr, @kableextra, @bookdown, @ggmap, @ggthemes.
